                ...
                <div class="card-actions btn-group">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                            <a href="{{ route('information.extensions.create') }}" class="dropdown-item">
                ...
                <table class="table table-vcenter card-table text-nowrap">
                    ...
                    @forelse ($extensions as $extension)
                        <tr>
                            ...
                            <td class="align-middle">
                                <x-button.show class="btn-icon" route="{{ route('information.extensions.show', $extension) }}"/>
                                <x-button.delete class="btn-icon" route="{{ route('information.extensions.destroy', $extension) }}"/>
                            </td>
                        </tr>
                    @empty
                        <tr>
